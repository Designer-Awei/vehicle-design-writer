...
export const PFDBIAnalysisSchema = z.object({
  ...
  peerComparisons: z.array(PeerComparisonSchema).catch([]),
  verticalComparisons: z.array(VerticalComparisonSchema).catch([]),
  horizontalComparisons: z.array(HorizontalComparisonSchema).catch([]),
